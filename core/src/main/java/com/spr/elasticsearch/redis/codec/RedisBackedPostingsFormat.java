...
public class RedisBackedPostingsFormat extends PostingsFormat {
    ...
    public FieldsConsumer fieldsConsumer(SegmentWriteState segmentWriteState) throws IOException {
        ...
        return new RedisBackedFieldsConsumer(shardId, field, indexService, segmentWriteState);
    }
    ...
    public FieldsProducer fieldsProducer(SegmentReadState segmentReadState) throws IOException {
        ...
        return new RedisBackedFieldsProducer(shardId, field, RedisIndicesService.getInstance().getIndexService(shardId.getIndex()), segmentReadState);
    }
}
