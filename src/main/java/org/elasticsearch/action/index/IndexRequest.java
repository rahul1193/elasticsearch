...
public class IndexRequest extends ShardReplicationOperationRequest<IndexRequest> implements DocumentRequest<IndexRequest> {
    ...
    public static final VersionType DEFAULT_VERSION_TYPE = VersionType.INTERNAL;
    public static final OpType DEFAULT_OP_TYPE = OpType.INDEX;
    ...
    private OpType opType = DEFAULT_OP_TYPE;
    private boolean autoGeneratedId = false;

    private boolean refresh = false;
    private long version = Versions.MATCH_ANY;
    private VersionType versionType = DEFAULT_VERSION_TYPE;
    ...
    public Map<String, String> getParams() {
        ...
        builder.putIf("version", String.valueOf(version), version != Versions.MATCH_ANY);
...
*/
    ...
    public RestRequest.Method getMethod() {
        if (autoGeneratedId || Strings.isEmpty(id)) {
    ...
    public HttpEntity getBulkEntity() throws IOException {
        ...
        Map<String, String> actionMetadata = Maps.newLinkedHashMap();
